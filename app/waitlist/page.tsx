...
export default function SubscribePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-gradient-to-br from-black via-green-900 to-black text-white">
      <div className="bg-gray-800 bg-opacity-90 p-10 rounded-md shadow-lg max-w-md w-full mx-4 text-center">
        ...
        {success ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <input
              ...
              className="w-full p-3 rounded border border-gray-600 bg-gray-700 text-white placeholder-gray-400 focus:outline-none focus:border-blue-500"
            />
